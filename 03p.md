...
<span class="infty_silent">(2) <ruby>慌<rp>(</rp><rt>（　　　）</rt><rp>)</rp></ruby>て戦く心は&#8230;（有島武郎）</span>

<span class="infty_silent">(3) ただ泣き泣きて御声の<ruby>戦慄<rp>(</rp><rt>（　　　）</rt><rp>)</rp></ruby>く&#8230;（行幸）</span>

<span class="infty_silent">(4) <ruby>干戈<rp>(</rp><rt>（　　　）</rt><rp>)</rp></ruby>し、自分を敵視するものを討つとあっては&#8230;（藤村）</span>
